        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="mb-6">
                            <h2 class="text-xl font-semibold text-gray-900">Derma</h2>
                            <p class="mt-1 text-sm text-gray-600">
                                Sila isi maklumat di bawah untuk membuat sumbangan kepada {{ mosque.name }}.
                            </p>
                        </div>
                        ...
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div class="border-t border-gray-200 pt-6">
                                <h3 class="text-lg font-medium text-gray-900">Maklumat Penderma (Pilihan)</h3>
                                <p class="mt-1 text-sm text-gray-600">
                                    Sila isi maklumat anda jika ingin menerima resit sumbangan.
                                </p>

                                <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                                    <div>
                                        <InputLabel for="donor_name" value="Nama" />
                                        <TextInput
                                            id="donor_name"
                                            type="text"
                                            class="mt-1 block w-full"
                                    ...
                                    <div>
                                        <InputLabel for="donor_phone" value="No. Telefon" />
                                        <TextInput
                                            id="donor_phone"
                                            type="tel"
                                            class="mt-1 block w-full"
                                    ...
                                    <div class="sm:col-span-2">
                                        <InputLabel for="donor_email" value="Emel" />
                                        <TextInput
                                            id="donor_email"
                                            type="email"
                                            class="mt-1 block w-full"
                            ...
                            <!-- Notes -->
                            <div>
                                <InputLabel for="notes" value="Catatan (Pilihan)" />
                                <textarea
                                    id="notes"
                                    v-model="form.notes"
                                    rows="3"
