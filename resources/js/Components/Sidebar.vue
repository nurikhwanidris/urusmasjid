...
const settingsItem = computed(() => {
    ...
    if (currentMosque.value) {
        return {
            ...
            params: [currentMosque.value.id],
            active: route().current('masjid.settings', { mosque: currentMosque.value.id }),
            icon: `<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="flex-1 overflow-y-auto py-6">
                <div class="space-y-2 px-2">
                    ...
                    <SidebarLink
                        ...
                        :active="route().current(settingsItem.route, settingsItem.params && settingsItem.params.length > 0 ? { mosque: settingsItem.params[0] } : {})"
                        :collapsed="props.collapsed"
                    >
                        <template #icon>
