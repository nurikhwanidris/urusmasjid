...
return [
    ...
    */
    ...
    'options' => [
         ...
         * This is required for embedding images from remote sites, but it can be a security risk.
         * Set to false if you want to prevent remote file access.
         *
         * @var bool
         */
        'enable_remote' => true,
         ...
         * Enable SVG support
         *
         * If this setting is set to true, DOMPDF will support SVG images.
         *
         * @var bool
         */
        'enable_svg' => true,
